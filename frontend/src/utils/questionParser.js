...
export const cleanText = (t) => {
  ...
  // FIX 7: השלמת נקודה חסרה אחרי אותיות תשובה, למשל "ד כאשר" -> "ד. כאשר"
  // מונע באג שבו התשובות לא מתפצלות והשאלה "נתקעת" ללא כפתורים!
  s = s.replace(/(^|\s)([א-ד])\s+((?:כאשר|אם|על|בדרך|לא|כל|רק|אסור|מותר|רכב|נהג)\b)/g, '$1$2. $3');
